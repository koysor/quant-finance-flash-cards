...
| Huber loss | piecewise — see below | Regression, fat-tailed errors |

$$L_\delta(y, \hat{y}) = \begin{cases}\dfrac{1}{2}(y-\hat{y})^2 & \lvert y-\hat{y}\rvert\leq\delta \\[4pt] \delta\lvert y-\hat{y}\rvert-\dfrac{\delta^2}{2} & \text{otherwise}\end{cases}$$
